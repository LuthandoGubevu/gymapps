...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-primary/10 bg-card text-card-foreground shadow-md backdrop-blur-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-primary/20",
      className
    )}
    {...props}
  />
