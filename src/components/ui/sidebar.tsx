    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar backdrop-blur-sm group-data-[variant=floating]:rounded-lg group-data-[variant=inset]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-white/20 group-data-[variant=inset]:border group-data-[variant=inset]:border-white/20 group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
